 ...
 * @date 2018/05/13 12:12:00
 */
require_once(BASEPATH.'libraries/lib/Wechat_basic.php');
class CI_Wechat_pay extends CI_Wechat_basic {
     ...
     * @return type
     */
    public function createMchPay($postdata) {
        $prepay_id=$this->getPrepayId($postdata);
        $option = array();
