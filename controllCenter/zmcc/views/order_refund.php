...
<!--                        <form action="<?php echo site_url("export/export_order") ?>" method="post" id="form-export">
                        ...
                        <form action="<?php echo site_url('Order/refundsOrder') ?>" method="post" id="form-search">
...
<!--                                <div class="form-group col-md-2">
                                ...
                                <div class="input-group col-md-3">
                                    ...
                                    <div class="input-group-btn">
                                        ...
                                        <button type="button" class="btn btn-default" style="margin-top:25px" onclick="javascript:location.href = '<?php echo site_url("Order/refundsOrder") ?>'">重置</button>
                                    </div>
                                </div>
                            </div>
                        </form>
