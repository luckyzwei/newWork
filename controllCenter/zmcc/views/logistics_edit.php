                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">修改配送区域费用</h3>
                                </div>
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            <div class="col-md-8">
                                                ...
                                                <input type="text" class="form-control"  name="logistics_name" placeholder="配送方式名称" value="<?php echo $logistics['logistics_name']?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-8">
                                                <label for="payment_name">首重 (Kg)</label>
                                                <input type="text" class="form-control" name="logistics_weight"  value="<?php echo $logistics['logistics_weight']?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-8">
                                                <label for="payment_name">首重费用(RMB/元) </label>
                                                <input type="text" class="form-control"  name="logistics_fee"  value="<?php echo $logistics['logistics_fee']?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-8">
                                                <label for="payment_name">续重费用(RMB/元) </label>
                                                <input type="text" class="form-control" name="logistics_add_fee"  value="<?php echo $logistics['logistics_add_fee']?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-8">
                                                ...
                                                <input type="checkbox" name="status" <?php echo $logistics["status"]?"checked":""?> value="1">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="box-footer">
                                        <input type="hidden" name="support_area" id="areaids">
                                        <input type="hidden" name="logistics_id" value="<?php echo $logistics['logistics_id']?>">
