            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">编辑店铺佣金状态</h3>
                    </div>
                    <form role="form" action="<?php site_url('Store/editRewardStatus');?>" name="userRewardStatusoption_form" id="userRewardStatusoption" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            ...
                            <button type="button" class="btn btn-prompt" onclick="location.href = '/index.php/User/editUserReward?store_id=<?php echo $rewardStatuss['user_id']?>'">返回</button>
                        </div>
                    </form>
                </div>
            </div>
