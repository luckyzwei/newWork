            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="tab-content">
                        <form role="form" method="post" action="" name="Active_form">
                                <div class="row">
                                    <div class="col-md-12">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <div class="col-md-8">
                                                            ...
                                                            <a href="" id="thumb-image" data-toggle="image" class="img-thumbnail" data-original-title="" title="图片上传">
                                                                <img height="100px" src="<?php echo base_url(); ?>upload/image/<?php echo empty($images) ? 'no_image.png' : $images; ?>" alt="" title="" data-placeholder="<?php echo empty($images) ? 'no_image.png' : $images; ?>">
                                                            </a>
                                                            <input type="hidden" name="images" value="<?php echo empty($images) ? 'no_image.png' : $images; ?>" id="input-image">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-8">
                                                            ...
                                                            <input type="text" class="form-control" id="article_category-id" name="category_name" placeholder="分类名称">
                                                            <input type="hidden" class="form-control" id="article_category-id" name="article_category_id" placeholder="分类ID">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-8">
                                                            ...
                                                            <input type="text" class="form-control" id="autor" name="author" placeholder="文章作者" value="<?php echo set_value('author')?>">
                                                        </div>
                                                    </div>
                                                </div>
