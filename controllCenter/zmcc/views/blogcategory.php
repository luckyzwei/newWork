                ...
                <section class="content">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">博客分类列表</h3>
                            <div class="box-tools">
                                <div class="has-feedback">
                                    <a href="<?php echo site_url('BlogCategory/addBlogCategory'); ?>"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-plus"></i></button></a>
                                </div>
                            </div>
                        </div>
                        <div class="box-body">
            ...
            function delDialog(id, name) {
                ...
                bootbox.confirm({
                    ...
                    callback: function (result) {
                        ...
                        if (result) {
                            $.ajax({
                                url: '../../../index.php/BlogCategory/deleteBlogCategory',
                                ...
                                success: function (data) {
                                    ...
                                    window.location.href="/index.php/BlogCategory/index";
                                },
                            });
                        } else {
                        }
