                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools">
                                <div class="has-feedback">
                                    <a href="<?php echo site_url('ArticleCategory/addArticleCategory'); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="box-body">
            ...
            function delDialog(id, name) {
                bootbox.confirm({
                    ...
                    callback: function (result) {
                        ...
                        if (result) {
                            $.ajax({
                                url: "<?php echo site_url('ArticleCategory/deleteArticleCategory');?>",
                                ...
                                success: function (data) {
                                    ...
                                    window.location.href="<?php echo site_url('ArticleCategory/index');?>";
                                },
                            });
                            console.log("确认")
                        } else {
