...
$(function(){
	//点击发送消息或者跳转页面的input时
    $('.sendMsg .sendMsg_input').attr('checked','checked');
    $('.menu_content_sendMsg').show();
    $('.sendMsg .sendMsg_input').click(function () {
    	$(this).attr('checked','checked');
        $('.jumpPage .jumpPage_input').removeAttr('checked')
        $('.menu_content_sendMsg').show();
        $('.menu_content_jumpPage').hide();

    })
    $('.jumpPage .jumpPage_input').click(function () {
        $(this).attr('checked','checked');
        $('.sendMsg .sendMsg_input').removeAttr('checked');
        $('.menu_content_sendMsg').hide();
        $('.menu_content_jumpPage').show();
