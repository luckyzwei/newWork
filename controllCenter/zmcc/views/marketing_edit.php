                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">编辑营销策略</h3>
                                </div>
                                <form role="form" action="<?php echo site_url('Marketing/editMarketing/' . $marketing['marketing_id']); ?>" name="adminoption_form" id="adminoption" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label class="col-sm-1 control-label" for="marketing_name">策略名称</label>
                                            <div class="col-md-8">
                                                <input type="text" name="marketing_name" id="marketing_name" class="form-control" placeholder="策略名称" value="<?php echo $marketing['marketing_name']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select id="input-type" name="marketing_type" class="form-control" style="width:15%">
                                                    <option value="O" <?php if ($marketing['marketing_type'] == 'O') echo 'selected'; ?>>订单策略</option>
                                                    <option value="P" <?php if ($marketing['marketing_type'] == 'P') echo 'selected'; ?>>商品策略</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group" container='marketingtrigger' id='marketingtiggerprice'>
                                            <label class="col-sm-1 control-label" for="marketing_trigger_price"> 满足金额</label>
                                            <div class="col-md-8">
                                                <input type="number" name="marketing_trigger_price" id='marketing_trigger_price' class="form-control" value="<?php echo $marketing['marketing_trigger_price']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group" id="marketingtirggernumber" container='marketingtrigger'> 
                                            <label class="col-sm-1 control-label" for="input-marketing_trigger_number"> 满足件数</label> 
                                            <div class="col-md-8">
                                                <input type="number" name="marketing_trigger_number" id='marketing_trigger_number' class="form-control" value="<?php echo $marketing['marketing_trigger_number']; ?>">
                                            </div>
                                        </div>
                                        <!--div class="form-group" id="marketingparallel" container='marketingparallel'>
                                            ...
                                            <div class="col-md-8">
                                                <input type="checkbox" name="marketing_parallel" value="1" id="input-marketing-parallel" class="form-control" <?php if ($marketing['marketing_parallel'] == 0) echo 'checked'; ?>/>
                                                <input type='hidden' name='marketing_id' value="">
                                                <span>(关于策略的并行！策略并行：是指在商品策略下 该商品同时享受商品策略和订单策略，无并行:是该商品如果有商品策略 则不享受订单策略)</span>
                                            </div>
                                        </div-->
                                        <div class="form-group">
                                            <label class="col-sm-1 control-label" for="marketing_kind">优惠方式</label>
                                            <div class="col-md-8">
                                                <select id="marketing_kind" name="marketing_kind" class="form-control" style="width:15%">
                                                    <option value="achieve_discount" <?php if ($marketing['marketing_kind'] == 'achieve_discount') echo 'selected'; ?>>满减金额</option>
                                                    <option value="achieve_give" <?php if ($marketing['marketing_kind'] == 'achieve_give') echo 'selected'; ?>>满赠商品</option>
                                                    <option value="achieve_coupon" <?php if ($marketing['marketing_kind'] == 'achieve_coupon') echo 'selected'; ?>>满赠优惠券</option>
                                                    <option value="achieve_reward" <?php if ($marketing['marketing_kind'] == 'achieve_reward') echo 'selected'; ?>>满赠积分</option>
                                                    <option value="achieve_freeshipping" <?php if ($marketing['marketing_kind'] == 'achieve_freeshipping') echo 'selected'; ?>>满额包邮</option>  
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group" container='marketing' id='achieve_discount'>
                                            <label for="input-marketing_discount" class="col-sm-1 control-label">优惠金额</label>
                                            <div class="col-md-8">
                                                <input type="number" name="marketing_discount" placeholder="优惠金额" class="form-control" id="marketing_discount" value="<?php echo $marketing['marketing_discount']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group" container='marketing' id='achieve_give'>
                                            <label for="give_product" class="col-sm-1 control-label" >满赠商品</label>
                                            <div class="col-md-8">
                                                ...
                                                <div id="give-product" class="well well-sm" style="height: 150px; overflow: auto;">
                                                    <?php foreach ($marketing['give_product'] as $give_product): ?>
                                                        <div id="give-product<?php echo $give_product['product_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $give_product['product_name']; ?>
                                        ...
                                        <div class="form-group" container='marketing' id='achieve_coupon'>
                                            <label for="input-marketing_coupon" class="col-sm-1 control-label" >满赠优惠券</label>
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group required" container='marketing' id='achieve_reward'>
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <input type="number" name="marketing_reward" placeholder="赠送积分" class="form-control" id="marketing_reward" value="<?php echo $marketing['marketing_reward']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select name="user_group" id="marketing_user_group" class="form-control">
                                                    ...
                                                    <?php foreach ($usergroups as $usergroup) : ?>
                                                        <option value="<?php echo $usergroup['user_group_id'] ?>" <?php if ($usergroup['user_group_id'] == $marketing['user_group']) echo "selected"; ?>><?php echo $usergroup['user_group_name'] ?></option>
                                                    <?php endforeach ?>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-1 control-label" for="input-category">
                                                <select name='category_applyorno'>
                                                    <option value='1' <?php if ($marketing['category_applyorno'] == 1) echo "selected" ?>>适用</option>
                                                    <option value='0' <?php if ($marketing['category_applyorno'] == 0) echo "selected" ?>>例外</option>
                                                </select>
                                                分类</label>
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-1 control-label" for="input-product">
                                                <select name='product_applyorno'>
                                                    <option value='1' <?php if ($marketing['product_applyorno'] == 1) echo "selected" ?>>适用</option>
                                                    <option value='0' <?php if ($marketing['product_applyorno'] == 0) echo "selected" ?>>例外</option>
                                                </select>商品
                                            </label>
                                            <div class="col-md-8">
                                                ...
                                                <div id="marketing-product" class="well well-sm" style="height: 150px; overflow: auto;">
                                                    <?php if (!empty($marketing['marketing_product'])) { ?>
                                                        <?php foreach ($marketing['marketing_product'] as $marketing_product): ?>
                                                            <div id="marketing-product<?php echo $marketing_product['product_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $marketing_product['product_name']; ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group date">
                                                    <input type="text" name="starttime" value="<?php echo date('Y-m-d H:i:s', $marketing['starttime']); ?>" placeholder="开始日期" data-date-format="YYYY-MM-DD HH:mm:ss" class="form-control" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group date"><input type="text" name="endtime" value="<?php echo date('Y-m-d H:i:s', $marketing['endtime']); ?>" placeholder="结束日期" data-date-format="YYYY-MM-DD HH:mm:ss" class="form-control" />
                                                    <span class="input-group-btn">
                                                        <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                                                    </span>
                                                </div>          
                                        ...
                                        <!--div class="form-group">
                                            <label class="col-sm-1 control-label" for="marketing_level">优先级</label>
                                            <div class="col-md-8">
                                                <input type="number" name="marketing_level" id="marketing_level" class="form-control" placeholder="优先级" value="<?php echo $marketing['marketing_level']; ?>">
                                            </div>
                                        </div-->
                                        <div class="form-group">
                                            <label class="col-sm-1 control-label" for="marketing_level">策略分组</label>
                                            <div class="col-md-8">
                                                <input type="text" name="marketing_group" id="marketing_group" class="form-control" placeholder="策略分组" value="<?php echo $marketing['marketing_group']; ?>">
                                            </div>
                                        </div>                         
                                    </div>                   
                                    <div class="box-footer">
                                        <input type='hidden' name='marketing_id' value="<?php echo isset($marketing['marketing_id']) ? $marketing['marketing_id'] : 0; ?>">
