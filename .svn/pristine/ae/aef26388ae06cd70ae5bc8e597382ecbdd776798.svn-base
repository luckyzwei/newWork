                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            <div class="col-md-8">
                                                ...
                                                <input type="text" class="form-control" id="api_name" name="name" placeholder="Api名称" value="<?php echo $api['name']?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-8">
                                                ...
                                                <input type="text" class="form-control" id="api_key"  name="appid" placeholder="Api ID"  value="<?php echo $api['appid'];?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-8">
                                                ...
                                                <input type="text" class="form-control" id="api_key"  name="key" placeholder="Api密钥"  value="<?php echo $api['key'];?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-8">
                                                ...
                                                <input type="checkbox" class="form-control" id="api_group" name="status" 
                                                       <?php if($api['status']=="1") echo "checked"?> value="1">
                                            </div>
                                        </div>
                                    </div>
