                ...
                <section class="content">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <form role="form" action="<?php echo site_url('product/addProduct');?>" method="post" id="form-product-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <select class="form-control" name='check_store'>
                                                    <option value="0" <?php if(!empty($check_store)&&$check_store==0):echo "selected";endif;?>>遵从系统配置</option>
