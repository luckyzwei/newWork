                ...
                <section class="content">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <form action="<?php echo site_url('Store/index') ?>" method="post">
                                <h3 class="box-title">店铺信息列表</h3>
                        ...
                        <div class="box-body no-padding">
                            <div class="table-responsive select-messages">
                                    <table class="table table-hover table-striped" style=" text-align:center;table-layout: fixed; width:100%;height: 100%";>
                                        <thead>
                                        <td style="width: 5%;">店铺ID</td>
                                        <td style="width: 15%;">店铺名称</td>
                                        <td style="width: 20%;">店铺简介</td>
                                        <td style="width: 10%;">店铺上级</td>
                                        ...
                                        <tbody>
                                            <?php foreach ($list as $value): ?>
                                                <tr>
                                                    ...
                                                    <td ><?php if($value['store_pid'] == 0){echo "系统";}else{echo $value['store_ming'];} ?></td>
                                                    ...
                                                    <td >    
                                                        ...
                                                        <a class="btn btn-primary btn-xs" href="<?php echo site_url('Store/storeOrderList/'.$value['store_id']);?>">店铺订单</a>
                                                        <a class="btn btn-primary btn-xs" href="<?php echo site_url('Store/storeProduct?store_id='.$value['store_id']);?>">商品管理</a>
                                                        <a class="btn btn-primary btn-xs" href="<?php echo site_url('Store/subStore?store_id='.$value['store_id']);?>">子店铺列表</a>
                                                    </td>
                                                    <td/>
                                                </tr>
<?php endforeach;
