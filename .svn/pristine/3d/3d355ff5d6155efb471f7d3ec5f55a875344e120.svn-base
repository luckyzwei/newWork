                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <form role="form" method="post" id='form-cdytyp' action="<?php echo site_url('commodityTyp/commodityTypAdd'); ?>">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <div class="col-md-8">
                                                <label for="cdytyp_name">类型名称</label>
                                                <input type="text" name="cdytyp_name" placeholder="商品类型名称"  class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-8">
                                        ...
                                        <block id="specifications">
                                            <div class="form-group col-md-8" id="specification_html" name="specification_group"  style="display: none">
                                                <div class="input-group col-sm-6">
                                                    <input type="text" name="specification_name[]"  placeholder="1级规格分组名称" class="form-control"  disabled="disabled">
