            ...
            <section class="invoice">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <h2 class="page-header">
                            <i class="fa fa-globe"></i> 订单编号 <?php echo $orderinfo['order_sn'] ?>
                ...
                <div class="row invoice-info">
                    ...
                    <div class="col-sm-12">
                        <b>收货人</b>
                        <address>
                            <strong><?php echo $orderinfo['fullname'] ?>(<?php echo $orderinfo['telephone'] ?>)</strong>
                ...
                <div class="row invoice-info">
                    ...
                    <div class="col-sm-12">
                        <b>发货人</b>
                        <address>
                            <strong><?php echo $orderinfo['send_user'] ?>(<?php echo $orderinfo['send_phone'] ?>)</strong>
                            <?php echo $orderinfo['send_address'] ?>
                        </address>
                    </div>
                </div>
