                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box box-primary">
                                ...
                                <form role="form" action="<?php echo site_url('Admin/editAdmin/'.$admin['admin_id']) ?>" name="useroption_form" id="useroption" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <div class="col-md-8">
                                                <label for="name">管理员名称</label>
                                                <input type="text" name="name" id="name" value="<?php echo $admin['name']; ?>" class="form-control" placeholder="管理员名称" <?php if ($admin['name'] == "root"): ?> readonly="true"<?php endif; ?>>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-8">
                                                ...
                                                <input type="password" name="password" id="password" class="form-control" placeholder="管理员密码" value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-8 avatar">
                                                ...
                                                <?php for ($i = 1; $i < 7; $i++) { ?>
                                                    <img src="./dist/avatar/male0<?php echo $i; ?>.jpg" width="60" class="<?php
                                                    if ($admin['avatar'] == './dist/avatar/male0' . $i . '.jpg'):echo 'selectedAvatar';
                                                    else:echo 'img';
                                                    endif;
                                                    ?>">
                                                <?php } ?>
                                                <?php for ($i = 1; $i < 7; $i++) { ?>
                                                    <img src="./dist/avatar/female0<?php echo $i; ?>.jpg" width="60" class="<?php
                                                         if ($admin['avatar'] == './dist/avatar/female0' . $i . '.jpg'):echo 'selectedAvatar';
                                                         else:echo 'img';
                                                         endif;
                                                         ?>">
<?php } ?>
...
<?php foreach ($rolelists as $rolelist): ?> 
                                                        <option value="<?php echo $rolelist['role_id'] ?>" <?php if ($rolelist['role_id'] == $admin['role_id']) echo "selected" ?>><?php echo $rolelist['role_name'] ?></option>
<?php endforeach; ?>
                                                </select> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-8">
                                                ...
                                                <select id="status" name="status" style="width:100%;height:34px;">
                                                    ...
                                                    <option value="2" <?php if ($admin['status'] == 2) echo 'selected' ?>>锁定</option>
                                                </select>                                                   
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-8">
                                                <label for="expiretime">管理员过期时间</label>
                                                <div class="input-group date"><input type="text" name="expiretime" value="<?php echo!empty($_SESSION['error']) ? $admin['expiretime'] : date('Y-m-d', $admin['expiretime']); ?>" placeholder="失效日期" data-date-format="YYYY-MM-DD" class="form-control" />
