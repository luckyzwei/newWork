                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">添加博客分类</h3>
                                </div>
                                <form role="form" method="post" action="<?php echo site_url('BlogCategory/addBlogCategory') ?>">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-8">
                                                ...
                                                <a href="" id="thumb-image" data-toggle="image" class="img-thumbnail" data-original-title="" title="图片上传">
                                                    <img height="100px" src="<?php echo base_url(); ?>upload/image/<?php echo empty($image) ? 'no_image.png' : $image; ?>" alt="" title="" data-placeholder="<?php echo empty($image) ? 'no_image.png' : $image; ?>">
                                                </a>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-8">
                                                <label >是否公开</label>
                                                <select name="published" value="" class="form-control select2" style="width:110px;">
                                                    <?php if ($blog['published'] == 0) { ?>
                                                        <option  selected="selected" value="0">公开</option>
                                                        <option  value="1">保密</option>
                                                    <?php } else if ($blog['published'] == 1) { ?> 
                                                        <option selected="selected"  value="1">保密</option>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-8">
                                                <label for="exampleInputNickName1">商店ID</label>
                                                <input type="text" name="store_id" class="form-control" id="exampleInputNickName1" placeholder="商店id">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-8">
                                                <label for="exampleInputNickName1">关键字</label>
                                                <input type="text" name="keywords" class="form-control" id="exampleInputNickName1" placeholder="关键字">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-8">
                                                <label >状态</label>
                                                <select name="status" value="" class="form-control select2" style="width:110px;">
                                                    <?php if ($blog['status'] == 0) { ?>
                                                        <option  selected="selected" value="0">发布</option>
                                                        <option  value="1">未发布</option>
                                                        <option  value="2">删除</option>    
                                                    <?php } else if ($blog['status'] == 1) { ?> 
                                                        <option selected="selected"  value="1">未发布</option>
                                                        <option  value="0">发布</option>
                                                        <option  value="2">删除</option>
                                                    <?php } else if ($blog['status'] == 2) { ?>
                                                        <option selected="selected" value="2">删除</option>
                                                        <option  value="1">未发布</option>
                                                        <option  value="0">发布</option>
                                                    <?php } ?>
                                                </select>
