                    ...
                    <form name="powerForm" id="powerForm" method="post">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">修改管理员角色</h3>
                            </div>
                            <div class="box-body">
                                <div class="form-group">
                                    <div class="col-md-8">
                                        <label for="forRolename">角色名称</label>
                                        <input type="text" class="form-control" id="rolename" name="role_name" placeholder="2-8个汉字" value='<?php echo $role["role_name"]?>'>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-8">
                         ...
                         <input type="hidden" name="role_power" id="role_power">
